...
public class GetResultsExample {
  ...
  public static void main(String[] args) {
    ...
    // Create client
    RealityDefender client = RealityDefender.builder().apiKey(apiKey).build();
    ...
    try {
      ...
      try {
        GetResultsOptions options = GetResultsOptions.builder().pageNumber(0).size(5).build();
      ...
      GetResultsOptions nameOptions =
          GetResultsOptions.builder().pageNumber(0).size(5).name("test").build();
      ...
      GetResultsOptions pollingOptions =
          GetResultsOptions.builder()
              .pageNumber(0)
              .size(5)
              .maxAttempts(30)
      ...
      CompletableFuture<DetectionResultList> futureResults =
          client.getResultsAsync(GetResultsOptions.builder().pageNumber(0).size(5).build());
  ...
  private static void printResults(DetectionResultList results) {
    ...
    System.out.println(
        "Current Page: " + (results.getCurrentPage() + 1) + " of " + results.getTotalPages());
