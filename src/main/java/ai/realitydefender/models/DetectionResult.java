...
public class DetectionResult {
    ...
    public DetectionResult(String requestId, ResultsSummary resultsSummary, Double score, List<ModelResult> models) {
        this.requestId = requestId;
        this.resultsSummary = resultsSummary;
        this.score = score;
        this.models = models;
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(requestId, that.requestId) && Objects.equals(this.getStatus(), that.getStatus());
    }
    ...
    public DetectionResult summarize() {
        return new DetectionResult(this.requestId, this.resultsSummary, this.getScore(), this.getModels());
    }
