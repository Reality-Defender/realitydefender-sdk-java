...
public class HttpClient implements Closeable {
    ...
    public JsonNode uploadFile(File file) throws RealityDefenderException {
        if (!file.exists()) {
            throw new RealityDefenderException("File not found: " + file.getAbsolutePath(), "INVALID_FILE");
        }

        if (!file.canRead()) {
            throw new RealityDefenderException("Cannot read file: " + file.getAbsolutePath(), "INVALID_FILE");
        }
    ...
    private JsonNode handleResponse(Response response, String defaultErrorCode) throws RealityDefenderException {
        try {
