...
class DetectionResultTest {
  ...
  void testDetectionResultCreation() {
    DetectionResult.ModelResult model1 =
        new DetectionResult.ModelResult("model1", "ARTIFICIAL", 0.95);
    DetectionResult.ModelResult model2 =
        new DetectionResult.ModelResult("model2", "ARTIFICIAL", 0.87);
  ...
  void testModelResultCreation() {
    DetectionResult.ModelResult model =
        new DetectionResult.ModelResult("test-model", "AUTHENTIC", 0.23);
