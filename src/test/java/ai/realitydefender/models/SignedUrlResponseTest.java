...
class SignedUrlResponseTest {
    ...
    void testSignedUrlResponseCreation() {
        SignedUrlResponse.SignedUrlData data = new SignedUrlResponse.SignedUrlData("https://example.com/signed-url");
    ...
    void testSignedUrlResponseEquality() {
        SignedUrlResponse.SignedUrlData data1 = new SignedUrlResponse.SignedUrlData("https://example.com/url1");
        SignedUrlResponse.SignedUrlData data2 = new SignedUrlResponse.SignedUrlData("https://example.com/url1");
        ...
        SignedUrlResponse response3 = new SignedUrlResponse("error", data1, 1, "media123", "request456");
    ...
    void testSignedUrlDataEquality() {
        SignedUrlResponse.SignedUrlData data1 = new SignedUrlResponse.SignedUrlData("https://example.com/url");
        SignedUrlResponse.SignedUrlData data2 = new SignedUrlResponse.SignedUrlData("https://example.com/url");
        SignedUrlResponse.SignedUrlData data3 = new SignedUrlResponse.SignedUrlData("https://different.com/url");
    ...
    void testSignedUrlResponseToString() {
        SignedUrlResponse.SignedUrlData data = new SignedUrlResponse.SignedUrlData("https://example.com/signed");
    ...
    void testSignedUrlDataToString() {
        SignedUrlResponse.SignedUrlData data = new SignedUrlResponse.SignedUrlData("https://test.com/url");
    ...
    void testJsonSerialization() throws Exception {
        SignedUrlResponse.SignedUrlData data = new SignedUrlResponse.SignedUrlData("https://example.com/upload");
    ...
    void testJsonDeserialization() throws Exception {
        ...
        assertEquals("https://storage.example.com/upload?token=xyz", response.getResponse().getSignedUrl());
    ...
    void testJsonRoundTrip() throws Exception {
        SignedUrlResponse.SignedUrlData originalData = new SignedUrlResponse.SignedUrlData("https://bucket.s3.amazonaws.com/file");
        SignedUrlResponse original = new SignedUrlResponse("success", originalData, 0, "media_roundtrip", "req_roundtrip");
    ...
    void testSuccessfulResponse() {
        SignedUrlResponse.SignedUrlData data = new SignedUrlResponse.SignedUrlData("https://upload.example.com/secure-upload");
        SignedUrlResponse response = new SignedUrlResponse("ok", data, 0, "media_success", "req_success");
    ...
    void testSignedUrlResponseReflexivity() {
        SignedUrlResponse.SignedUrlData data = new SignedUrlResponse.SignedUrlData("https://example.com/test");
