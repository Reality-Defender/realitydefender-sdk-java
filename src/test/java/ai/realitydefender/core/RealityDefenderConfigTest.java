...
class RealityDefenderConfigTest {
    ...
    void testConfigWithNullApiKey() {
        assertThrows(NullPointerException.class, () -> {
            new RealityDefenderConfig(null, "https://api.realitydefender.com", Duration.ofSeconds(30));
        });
    }
    ...
    void testConfigEquality() {
        RealityDefenderConfig config1 = new RealityDefenderConfig(
                "api-key", "https://api.realitydefender.com", Duration.ofSeconds(30));
        RealityDefenderConfig config2 = new RealityDefenderConfig(
                "api-key", "https://api.realitydefender.com", Duration.ofSeconds(30));
