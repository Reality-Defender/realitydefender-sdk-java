...
class DetectionServiceTest {
    ...
    void testGetResultPollingSuccess() throws Exception {
        ...
        // Act
        DetectionResult result = detectionService.getResult("req-123", Duration.ofMillis(10), Duration.ofSeconds(5));
    ...
    void testPollForResultsTimeout() throws Exception {
        ...
        // Act & Assert
        assertThrows(RealityDefenderException.class, () -> {
    ...
    void testUploadFailure() throws Exception {
        ...
        // Act & Assert
        RealityDefenderException exception = assertThrows(RealityDefenderException.class, () -> {
    ...
    void testPollForResultsAsync() throws Exception {
        ...
        // Act
        CompletableFuture<DetectionResult> future = detectionService.pollForResultsAsync(
                "req-456",
                Duration.ofMillis(10),
                Duration.ofSeconds(5)
        );
